...
let eat, match, eatMatch, guard, hold, stackHeld;
...
class RegexNodeGrammar {
  ...
  *Assertion() {
  ...
  // @Node
  *Character() {
    yield eat(t.TokenMatcher('Character'));
  }
...
export { RegexNodeGrammar as NodeGrammar };
export { RegexTokenGrammar as TokenGrammar };
