 ...
 * @generatedfrom ./grammar.macro.js#de21a9429128d0346ed1b4c1bbeda40931d4fa70
...
var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _initProto;
...
export const grammar = (_dec = Attributes(Object.keys(flagCharacters)), _dec2 = CoveredBy('Element'), _dec3 = CoveredBy('Element'), _dec4 = CoveredBy('Assertion'), _dec5 = CoveredBy('Assertion'), _dec6 = Attributes(['negate']), _dec7 = CoveredBy('Assertion'), _dec8 = CoveredBy('Assertion'), _dec9 = CoveredBy('Element'), _dec10 = CoveredBy('CharacterClassElement'), _dec11 = Attributes(['negate']), _dec12 = CoveredBy('Element'), _dec13 = CoveredBy('CharacterClassElement'), _dec14 = CoveredBy('Element'), _dec15 = CoveredBy('CharacterSet'), _dec16 = Attributes(['negate']), _dec17 = CoveredBy('CharacterSet'), _dec18 = Attributes(['negate']), _dec19 = CoveredBy('CharacterSet'), _dec20 = Attributes(['negate']), _dec21 = CoveredBy('CharacterSet'), _dec22 = Attributes(['min', 'max']), _dec23 = Attributes(['cooked']), _dec24 = InjectFrom(Shared), _dec25 = InjectFrom(Shared), _dec26 = InjectFrom(Shared), class RegexGrammar {
  static {
    [_initProto] = _applyDecs(this, [[Node, 2, "Pattern"], [[_dec, AllowEmpty, Node], 2, "Flags"], [AllowEmpty, 2, "Alternatives"], [[AllowEmpty, Node], 2, "Alternative"], [AllowEmpty, 2, "Elements"], [[_dec2, Node], 2, "Group"], [Node, 2, "CapturingGroup"], [_dec3, 2, "Assertion"], [[_dec4, Node], 2, "StartOfInputAssertion"], [[_dec5, Node], 2, "EndOfInputAssertion"], [[_dec6, _dec7, Node], 2, "WordBoundaryAssertion"], [[_dec8, Node], 2, "Gap"], [[_dec9, _dec10, Node], 2, "Character"], [[_dec11, _dec12, Node], 2, "CharacterClass"], [[_dec13, Node], 2, "CharacterClassRange"], [_dec14, 2, "CharacterSet"], [[_dec15, Node], 2, "AnyCharacterSet"], [[_dec16, _dec17, Node], 2, "DigitCharacterSet"], [[_dec18, _dec19, Node], 2, "SpaceCharacterSet"], [[_dec20, _dec21, Node], 2, "WordCharacterSet"], [[_dec22, Node], 2, "Quantifier"], [Node, 2, "UnsignedInteger"], [[_dec23, Node], 2, "EscapeSequence"], [Node, 2, "EscapeCode"], [Node, 2, "Digit"], [_dec24, 2, "Any"], [[Node, _dec25], 2, "Keyword"], [[Node, _dec26], 2, "Punctuator"]], []).e;
  }
  constructor(...args) {
    _initProto(this);
  }
